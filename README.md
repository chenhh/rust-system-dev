...
語法由核心庫([crate core](https://doc.rust-lang.org/core/index.html))與標準庫([crate std](https://doc.rust-lang.org/std/))所提供。

而核心庫是標準庫的基準，為rust語言的核心，不依賴於作用系統和網路相關的庫，沒有堆疊分配、平行處理和I/O的功能。
